...
import candyScene from "../assets/3d/candy_island.glb";

export function CandyIsland({
    isRotating,
    setIsRotating,
    setCurrentStage,
    currentFocusPoint,
  ...
  const { nodes, materials } = useGLTF(candyScene);
  ...
  return (
    // 3d Model from :https://sketchfab.com/3d-models/candy-island-0f51283fff9e459ea2cbad306e206ad8
